...
module.exports = function(app, express) {
    ...
    apiRouter.post('/authenticate', function(req, res) {
        ...
        }).select('_id name username pic admin password').exec(function(err, user) {
    ...
    .post(function(req, res) {
        ...
        if (user.weight && !validator.isNumeric(user.weight))
            errormsg += "Email Invalid\n";

        if (user.height && !validator.isNumeric(user.height))
            errormsg += "Email Invalid\n";
    ...
    .post(function(req, res) {
        ...
        measure.datetime = req.body.datetime;
